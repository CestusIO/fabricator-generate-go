...
import (
	...
	"code.cestus.io/tools/fabricator-generate-go/pkg/fabricator-generate-go/templates"
)

//PluginName is the name of the plugin
const PluginName string = "fabricator-generate-go"
...
func NewFabricatorGenerateGo(ioStreams fabricator.IOStreams, flagparser fabricator.FlagParser) *cobra.Command {
	//endregion
	cmd := &cobra.Command{
		Use:     PluginName,
